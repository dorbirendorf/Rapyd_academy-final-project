...
function extractBusinessFromObj(obj: IBusinessFromDb): IBusiness {
    const { account_id, currency, balance, status, type, company_id, company_name,
        context, address_id, country_name, country_code, postal_code, city, region, street_name, street_number } = obj
    const business: IBusiness = { account_id, currency, balance, status, type, company_id, company_name, context };
