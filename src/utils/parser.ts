import { IIndividualFromDB, IIndividual, IFamily, IBusiness, IBusinessFromDb, IAccount, IFamilyFromDb, IAccountFromDb } from "../types/types.js"
...
class Parser {
    parseIndividualFromObj(obj: IIndividualFromDB): IIndividual {
        try {
            ...
            const individual: IIndividual = { account_id, agent_id, currency, balance, status: statusString, type, individual_id, first_name, last_name, email };
    ...
    parseFamilyFromObj(obj: IFamilyFromDb): IFamily {
        try {
            ...
            const family: IFamily = { account_id, currency, balance, agent_id, status: statusString, type, context };
    ...
    ParseBusinessFromObj(obj: IBusinessFromDb): IBusiness {
        try {
            ...
            const business: IBusiness = { account_id, currency, agent_id, balance, status: statusString, type, company_id, company_name, context };
    ...
    ParseAccountFromObj(obj: IAccountFromDb): IAccount {
        try {
            ...
            const { account_id, currency, balance, agent_id, status, type } = obj;
            const statusString = status ? "active" : "inactive";
            const account: IAccount = { account_id, currency, agent_id, balance, status: statusString, type };
